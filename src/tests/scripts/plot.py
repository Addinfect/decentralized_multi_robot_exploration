...
sns.boxenplot(data=df.loc[(df['World']=='belgioioso')], x="Number_Robots",y="Time", hue="Assigner")
fig = plt.figure()
sns.boxenplot(data=df.loc[(df['World']=='belgioioso')], x="Number_Robots",y="Total_Distance", hue="Assigner")
